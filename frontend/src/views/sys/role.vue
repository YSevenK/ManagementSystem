        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            <el-form :model="roleForm" ref="roleFormRef" :rules="rules">
                ...
                <el-form-item label="权限设置" prop="menuIdList" :label-width="formLabelWidth">
                    <el-tree :data="menuList" :props="menuProps" show-checkbox default-expand-all node-key="menuId"
                        ref="menuRef" style="width: 85%"></el-tree>
                </el-form-item>
            </el-form>
...
export default {
    ...
    methods: {
        ...
        saveRole() {
            let checkedKyes = this.$refs.menuRef.getCheckedKeys();
            let halfCheckedKyes = this.$refs.menuRef.getHalfCheckedKeys();
